...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_rtree_2eproto 
...
class LeafNode : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pbrtree.LeafNode) */ {
 public:
  ...
  inline LeafNode* New() const final {
    return CreateMaybeMessage<LeafNode>(NULL);
  }
  ...
  private:
  const ::pbrtree::Rectangle& _internal_minimum_bounding_rectangle() const;
  public:
...
class Leaves : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pbrtree.Leaves) */ {
 public:
  ...
  inline Leaves* New() const final {
    return CreateMaybeMessage<Leaves>(NULL);
  }
...
class Segments : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pbrtree.Segments) */ {
 public:
  ...
  inline Segments* New() const final {
    return CreateMaybeMessage<Segments>(NULL);
  }
...
inline const ::pbrtree::Rectangle& LeafNode::_internal_minimum_bounding_rectangle() const {
