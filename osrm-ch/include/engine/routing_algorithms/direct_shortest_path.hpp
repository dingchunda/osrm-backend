                    ...
                    InternalRouteResult &raw_route_data) const
    {
        ...
        if (source_phantom.forward_segment_id.enabled)
        {
            ...
            util::SimpleLogger().Write(logWARNING)
                    << "[forward] node: " << source_phantom.forward_segment_id.id
                    << ", offset: " << -source_phantom.GetForwardWeightPlusOffset();
        }
        if (source_phantom.reverse_segment_id.enabled)
        {
            ...
            util::SimpleLogger().Write(logWARNING)
                    << "[forward] node: " << source_phantom.reverse_segment_id.id
                    << ", offset: " << -source_phantom.GetReverseWeightPlusOffset();
        }
        ...
        if (target_phantom.forward_segment_id.enabled)
        {
            ...
            util::SimpleLogger().Write(logWARNING)
                    << "[reverse] node: " << target_phantom.forward_segment_id.id
                    << ", offset: " << target_phantom.GetForwardWeightPlusOffset();
        }
        ...
        if (target_phantom.reverse_segment_id.enabled)
        {
            ...
            util::SimpleLogger().Write(logWARNING)
                    << "[reverse] node: " << target_phantom.reverse_segment_id.id
                    << ", offset: " << target_phantom.GetReverseWeightPlusOffset();
        }
        ...
        std::string _path = "";
        for (NodeID n : packed_leg) {
            _path += std::to_string(n) + " -> ";
        }
